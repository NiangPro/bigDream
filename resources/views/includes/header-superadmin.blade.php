                ...
                <div class="dropdown-menu dropdown-menu-end shadow-lg">
                    <div class="dropdown-item">
                        <div class="d-flex py-2 border-bottom">
                            <img src="includes/images/user.png" class="img-3x me-3 rounded-3" alt="Admin Dashboards" />
                            <div class="m-0">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex py-2 border-bottom">
                            <img src="includes/images/user2.png" class="img-3x me-3 rounded-3" alt="Admin Dashboards" />
                            <div class="m-0">
                    ...
                    <div class="dropdown-item">
                        <div class="d-flex py-2">
                            <img src="includes/images/user1.png" class="img-3x me-3 rounded-3" alt="Admin Dashboards" />
                            <div class="m-0">
        ...
        <div class="header-profile d-flex align-items-center">
            <div class="dropdown">
                <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                    ...
                    <span class="avatar">
                        <img src="includes/images/user7.png" alt="Admin Templates" />
